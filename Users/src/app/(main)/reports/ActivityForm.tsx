        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Título de la Actividad <span className="text-red-500">*</span></FormLabel>
                  <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-col">
                    <FormLabel>Fecha de la Actividad <span className="text-red-500">*</span></FormLabel>
                    <Popover>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Descripción de la Actividad <span className="text-red-500">*</span></FormLabel>
                  <FormControl>
                    <Textarea
                      rows={5}
              ...
              <div className="mt-4 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
                {previewUrls.map((url, index) => (
                   <div key={index} className="relative group">
                     ...
                     <button type="button" onClick={() => removeImage(url)} className="absolute top-1 right-1 bg-red-600 text-white rounded-full p-1 opacity-0 group-hover:opacity-100 transition-opacity" disabled={isSubmitting}>
                       <X className="h-3 w-3" />
                     </button>
                   </div>
                ))}
