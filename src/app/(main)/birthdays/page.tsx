    ...
    try {
      ...
      if (birthday.isMember) {
        toast({
          ...
          description: 'Este cumpleaños pertenece a un miembro. Actualiza la información del miembro en la sección de Miembros.',
          variant: 'destructive'
        });
        return;
      }
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Personas que cumplen años en los próximos 14 días.
          </CardDescription>
        </CardHeader>
        <CardContent>
          {loading ? (
                  ...
                  <Tooltip key={b.id}>
                    ...
                    <TooltipContent>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {format((b as any).nextBirthday, "'Cumple el' d 'de' LLLL", { locale: es })}
                      </p>
                    </TooltipContent>
                  </Tooltip>
                ))}
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-start">
            <div>
              <CardTitle>Lista de Cumpleaños</CardTitle>
              <CardDescription>
                Todos los cumpleaños registrados, ordenados por proximidad.
              </CardDescription>
            </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Próximo Cumpleaños</TableHead>
