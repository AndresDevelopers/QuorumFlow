...
exports.notifications = exports.generateReport = exports.cleanupProfilePictures = void 0;
        ...
        try {
            ...
            const imageModule = new docxtemplater_image_module_free_1.default({
                ...
                getImage: async (tagValue) => {
                    const response = await axios_1.default.get(tagValue, { responseType: "arraybuffer" });
